...
const FormContact = () => {
  return (
    <Container id='contacto' className='mt-3 pt-3'>
      <h2 style={{ color: "#fff", textAlign: "center", margin: "10px"}}>Contacto</h2>
      <Form action="https://formsubmit.co/reactjsgrupo5@gmail.com" method="POST" style={{ width: "50%", margin: "0 auto"}}>
        ...
        <Form.Group controlId="email" style={{ margin:"10px 0"}}>
          ...
          <Form.Control as="textarea" name="textarea" required />
        </Form.Group>      
