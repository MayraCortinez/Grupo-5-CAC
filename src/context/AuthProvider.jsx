 ...
 const AuthProvider = ({ children }) => {
  ...
  const checkOrders = (user) => {
    ...
    // Utilizamos la función 'getDocs' para obtener todos los documentos de la colección 'orders' y aplicamos una consulta por 'userId'
      ...
      const userOrdersQuery = query(ordersRef, where('userId', '==', user.id));    /* utilizamos query para crear una consulta y where 
      ...
      .catch((error) => {
        console.log('Error al traer las órdenes', error);
      })
    }
  };
